...
export default function Hero() {
	...
	return (
		<section
			id="about"
			className="hero-glow relative flex min-h-screen flex-col justify-center px-6 pt-16"
		>
			<div className="relative mx-auto w-full max-w-5xl">
				...
				<h1 className="mb-4 text-6xl font-bold leading-[1.05] tracking-tight text-fg">
					Kevin Feng{" "}
					<sub className="text-[0.45em] font-normal text-mut tracking-[0.2em]">
						馮叔恩
					</sub>
				</h1>
				...
				<p className="mb-9 max-w-xl text-[15px] leading-relaxed text-mut">
					{/* TODO: 替換為個人簡介 */}
					擅長運用 Agentic Coding Workflow，將 AI Agent
					整合至需求分析、實作、重構與文件維護流程中，提升開發效率，同時維持程式品質與架構一致性。
